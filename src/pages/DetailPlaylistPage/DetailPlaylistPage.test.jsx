...
import DetailPlaylistPage from './DetailPlaylistPage.jsx';  
...
describe('DetailPlaylistPage', () => {
    ...
    test('fetches and renders playlist, sets title', async () => {
        render(
            <MemoryRouter initialEntries={['/playlists/playlist1']}>
                <Routes>
                    <Route path="/playlists/:id" element={<DetailPlaylistPage />} />
                </Routes>
            </MemoryRouter>
        );
